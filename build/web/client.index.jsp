...
//]]>
    ...
    <style>
        ...
        .rowfilter > div {
            margin-right: 10px; /* Tạo khoảng cách giữa các thẻ div */
        }
...
<!--                                    <button><a href="sapxep">Sắp xếp theo giá</a></button>-->
                                    ...
                                    <div style="display: flex; justify-content: center; align-items: center;">
                                        <c:forEach begin="${1}" end="${requestScope.num}" var="i">
                                            <p class="dispage" style="background-color: #000;  width: 30px; height: 20px; display: block; margin-right: 5px; cursor: pointer; clear: both"><a class="${i==page?'active':''}" style="color: white; padding-left: 11px; justify-content: center;align-items: center;" href="product?page=${i}">${i}</a></p>                                
                                            </c:forEach>
                                    </div>
                                </div>
                                ...
                                <div class="row content-product-list products-resize">
                                    ...
                                    <div style="display: flex; justify-content: center; align-items: center;">
                                        <c:forEach begin="${1}" end="${requestScope.num1}" var="i1">
                                            <p class="dispage" style="background-color: #000;  width: 30px; height: 20px; display: block; margin-right: 5px; cursor: pointer; clear: both"><a class="${i1==page?'active':''}" style="color: white; padding-left: 11px; justify-content: center;align-items: center;" href="product?page1=${i1}">${i1}</a></p>                                
                                            </c:forEach>
                                    </div>
                                </div>
                            </c:if>
                            ...
                            <div class="row content-product-list products-resize">
                                ...
                                <div style="display: flex; justify-content: center; align-items: center;">
                                    <c:forEach begin="${1}" end="${requestScope.num2}" var="i2">
                                        <p class="dispage" style="background-color: #000;  width: 30px; height: 20px; display: block; margin-right: 5px; cursor: pointer; clear: both"><a class="${i2==page?'active':''}" style="color: white; padding-left: 11px; justify-content: center;align-items: center;" href="product?page2=${i2}">${i2}</a></p>                                
                                        </c:forEach>
                                </div>
                            </div>
                        </c:if>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-3 col-xs-12 clear-sm">
                                <div class="widget-wrapper animated">
                                    ...
                                    <div class="inner">
                                        <form accept-charset='UTF-8' action='/account/contact' class='contact-form' method='get'>
                                            <input name='form_type' type='hidden' value='customer'>
                                            <input name='utf8' type='hidden' value='✓'>
                                            <div class="group-input"> 
                                                <input type="hidden" id="contact_tags" name="contact[tags]" value="khách hàng tiềm năng, bản tin" />     
                                                <input type="email" required="required" name="contactemail" id="contact_email" />
                                                <span class="bar"></span>
