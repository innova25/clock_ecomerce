    ...
    <div id="page">
        <div id="quick-view-modal" class="wrapper-quickview" style="display:none;">
            ...
            <div class="jsQuickview">
                ...
                <div class="col-md-7">
                    <form id="form-quickview" method="get" action="/cart/add">
                        ...
                        <div class="row">
                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                <ul class="nav navbar-nav clearfix">
                                    ...
                                    <li class="dropdown">
                                        <a href="#" title="Đồng hồ nam" class="">
                                            <span>Quản lí</span>
                                        </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            ...
                                            <div class="select-wrapper ">
                                                ...
                                                <label>100 chiếc</label>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6 col-md-12 col-sm-6 col-xs-12">
                                                    <button class=" btn-detail btn-color-add btn-min-width btn-mgt addtocart-modal" name="add"> 
                                                        <a href="/prj302/adminupdateinfor?idpro=${p.id}">Update Information</a> 
                                                    </button>
                                                </div>
                                                <div class="col-lg-6 col-md-12 col-sm-6 col-xs-12">								
                                                    <button   class=" btn-detail btn-color-buy btn-min-width btn-mgt" onclick="confirmDelete(${p.id})">
                                                         Xóa
                                                    </button>
                                                </div>	
                                            </div>
                                            <script>
                                                ...
                                                if (result) {
                                                window.location.href = "/prj302/admindeletepro?idpro=" + idpro;
                                                }
                                                }
                                            </script>
                                        </div>
