                            ...
                            <div class="order-summary-section order-summary-section-product-list" data-order-summary-section="line-items">
                                <table class="product-table">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach var="cart" items="${carts1}">
                                            <tr class="product" data-product-id="1004862902" data-variant-id="1012030836">
                                                <td class="product-image">
                                                    <div class="product-thumbnail">
                                                        <div class="product-thumbnail-wrapper">
                                                            <img class="product-thumbnail-image" alt="${cart.value.product.name}" src="/prj302/assets/product.hstatic.net/${cart.value.product.listimg[0].link}" />
                                                        </div>
                                                        <span class="product-thumbnail-quantity" aria-hidden="true">${cart.value.quantity}</span>
                                                    </div>
                                                </td>
                                                <td class="product-description">
                                                    <span class="product-description-name order-summary-emphasis">${cart.value.product.name}</span>
                                                </td>
                                                <td class="product-quantity visually-hidden">${cart.value.quantity}</td>
                                                <td class="product-price">
                                                    <span class="order-summary-emphasis">${cart.value.product.newprice * cart.value.quantity}₫</span>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
