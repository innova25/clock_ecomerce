<%-- 
    Document   : dssanpham
    Created on : Oct 19, 2023, 10:19:43 AM
    Author     : admin
--%>
                                    ...
                                    <tbody>
                                            ...
                                            <td class="product-image">
                                                <div class="product-thumbnail">
                                                    <div class="product-thumbnail-wrapper">
                                                        <img class="product-thumbnail-image" alt="ĐỒNG HỒ NAM SKMEI KIM XANH DƯƠNG" src="/prj302/assets/product.hstatic.net/product/product/1_e0ed7c0240734782a8268793dce0b9b8_small.jpg" />
                                                    </div>
                                        ...
                                        <tr class="product" data-product-id="1004853557" data-variant-id="1012006173">
                                            <td class="product-image">
                                                <div class="product-thumbnail">
                                                    <div class="product-thumbnail-wrapper">
                                                        <img class="product-thumbnail-image" alt="ĐỒNG HỒ NAM TEVISE 1952 CHẠY CƠ CỰC CHẤT" src="/prj302/assets/product.hstatic.net/product/product/7_0590d26379fb4da3ba8d9b57564ee6b0_small.jpg" />
                                                    </div>
