 ...
 * @author admin
 */
@WebServlet(name="productMale", urlPatterns={"/productmale"})
public class productMale extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet productMale</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet productMale at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        //3
        request.getRequestDispatcher("client.indexmale.jsp").forward(request, response);
    } 
