<%-- 
    Document   : xemgiohang
    Created on : Oct 19, 2023, 10:21:01 AM
    Author     : admin
--%>
    ...
    <div id="page">
        <div id="quick-view-modal" class="wrapper-quickview" style="display:none;">
            ...
            <div class="jsQuickview">
                ...
                <div class="col-md-7">
                    <form id="form-quickview" method="post" action="/prj302/addtocart">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 logo">
                                <div class="row">
                                    ...
                                    <div class="hidden-lg hidden-md col-sm-5 col-xs-5 mobile-icons" >
                                        <div>
                                            <a href="/prj302/client.xemgiohang.jsp" title="Xem giỏ hàng" class="mobile-cart"><span>5</span></a>
                                        ...
                                        <div id="layout-page" class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <table>
                                                ...
                                                <tbody>
                                                    ...
                                                    <form action="updatecart?id=${cart.value.product.id}">
                                                        <tr>
                                                        <input type="hidden" name="id" value="${cart.value.product.id}"/>
                                                        <td class="image">
                                                            <div class="product_image">
                                                                <a href="/prj302/chitietsanpham?id=${cart.value.product.id}">
                                                                    <img src="/prj302/assets/product.hstatic.net/${cart.value.product.listimg[0].link}" alt="${cart.value.product.name}" />
                                                                </a>
                                                            </div>
                                                        </td>
                                                        <td class="item">
                                                            <a href="/prj302/chitietsanpham?id=${cart.value.product.id}">
                                                                <strong>${cart.value.product.name}</strong>
                                                            </a>
                                                        </td>
                                                        <td class="qty">
                                                            <input type="number" onchange="this.form.submit()" name="quantity" value="${cart.value.quantity}" class="tc item-quantity" />
                                                        </td>
                                                        <td class="price">${cart.value.product.newprice * cart.value.quantity}₫</td>
                                                        <td class="remove">
                                                            <a href="/prj302/deletecart?id=${cart.value.product.id}" class="cart">Xóa</a>
                                                        </td>
                                                        <c:set var="itemPrice" value="${cart.value.product.newprice * cart.value.quantity}" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12 cart-buttons inner-right inner-left">
                                                    <div class="buttons clearfix">
                                                        <button  id="checkout" class="button-default" name="checkout" value="" ><a href="checkout">Thanh toán</a></button>
                                                    </div>
                                                </div>
