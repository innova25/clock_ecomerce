		...
		if(cart)
		{
			...
			jQuery.each(cart.items,function(i,item){
				...
				if(item.image != null)
					...
					tr.find('.item-image').html("<img src='//hstatic.net/design/theme-default/no-image.png'>");
...
function clone_item(product){
	...
	if ( product.image == null ) {
		item_product.find('img').attr('src','//hstatic.net/design/theme-default/no-image.png').attr('alt', product.url);
	} else {
