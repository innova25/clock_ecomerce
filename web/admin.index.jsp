                    ...
                    new Chart(ctx,
                            {
                                ...
                                data: {
                                    ...
                                    datasets: [{
                                            label: 'Số lượng',
                                            data: [${c[0].totalsale},${c[1].totalsale},${c[2].totalsale},${c[3].totalsale},${c[4].totalsale},${c[5].totalsale},${c[6].totalsale},${c[7].totalsale},${c[8].totalsale},${c[9].totalsale},${c[10].totalsale},${c[11].totalsale}],
                                            borderWidth: 1
                                        }]
                                },
                                options: {
                        ...
                        <div class="product-list clearfix">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <aside class="styled_header  use_icon ">
                                        <h3>SỐ LƯỢNG SẢN PHẨM BÁN ĐƯỢC TRONG 7 NGÀY</h3>
                                        <span class="icon" id="chartToggle2"><img src="/prj302/assets/theme.hstatic.net/icon_featured.png?v=90" alt=""></span>
                                    </aside>
                                </div>
                            </div>
                            <div>
                                    ...
                                    new Chart(ctx2,
                                            {
                                                type: 'bar',
                                                data: {
                                                    labels: ['5-11', '6-11', '7-11', '8-11', '9-11', '10-11', '11-11'],
                                                    datasets: [{
                                                            label: 'Số lượng',
                                                            data: [${c2[0].totalsale},${c2[1].totalsale},${c2[2].totalsale},${c2[3].totalsale},${c2[4].totalsale},${c2[5].totalsale},${c2[6].totalsale},${c[7].totalsale},${c[8].totalsale},${c[9].totalsale},${c[10].totalsale},${c[11].totalsale}],
                                                            borderWidth: 1
                                                        }]
                                                },
                                                options: {
                            ...
                            <script>
                                ...
                                const chartToggle2 = document.getElementById('chartToggle2');
                                let chartVisible2 = false;
                                chartToggle2.addEventListener('click', function () {
                                    if (chartVisible2) {
                                        // Nếu biểu đồ đang hiển thị, ẩn nó
                        ...
                        <div class="product-list clearfix">	
                                ...
                                new Chart(ctx1,
                                        {
                                            ...
                                            data: {
                                                ...
                                                datasets: [{
                                                        label: 'VND',
                                                        data: [${c1[0]},${c1[1]},${c1[2]},${c1[3]},${c1[4]},${c1[5]},${c1[6]},${c1[7]},${c1[8]},${c1[9]},${c1[10]},${c1[11]}],
                                                        borderWidth: 1
                                                    }]
                                            },
                                            options: {
                            ...
                            <script>
                                ...
                                const chartToggle1 = document.getElementById('chartToggle1');
                                let chartVisible1 = false;
                                chartToggle1.addEventListener('click', function () {
                                    if (chartVisible1) {
