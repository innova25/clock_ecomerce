        ...
        <ul>
            ...
            <li class="has-children">
                ...
                <ul class="child count-nav-6">
                    <li><a href="/prj302/productmale?type=1">Đồng hồ Tevise</a></li>
                    <li><a href="/prj302/productmale?type=2">Đồng hồ Skmei</a></li>
                    <li><a href="/prj302/productmale?type=3">Đồng hồ Halei</a></li>
                    <li><a href="/prj302/productmale?type=5">Đồng hồ Longbo</a></li>
                    <li><a href="/prj302/productmale?type=6">Đồng hồ nam Curren</a></li>
                    <li><a href="/prj302/productmale?type=4">Đồng hồ nam Baishuns</a></li>
                </ul>
            </li>
            <li class="has-children">
                <a href="/prj302/productfemale">Đồng hồ nữ</a>
                <ul class="child count-nav-3">
                    <li><a href="/prj302/productfemale?type=7">Đồng hồ Beesister</a></li>
                    <li><a href="/prj302/productfemale?type=8">Đồng hồ Skmei</a></li>
                    <li><a href="/prj302/productfemale?type=9">Đồng hồ Halei</a></li>
                </ul>
            </li>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <aside class="styled_header  use_icon ">
                                            <h2>All</h2>
                                            <h3>TẤT CẢ SẢN PHẨM DÀNH CHO NỮ</h3>
                                ...
                                <div class="row content-product-list products-resize">
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-6 pro-loop">
                                            <div class="product-block product-resize">
                                                <div class="product-img image-resize view view-third">
                                                    ...
                                                    <a href="chitietsanpham?id=${p.id}" title="${p.name}">
                                                ...
                                                <div class="product-detail clearfix">
                                                    <!-- sử dụng pull-left -->
                                                    <h3 class="pro-name"><a href="chitietsanpham?id=${p.id}" title="${p.name}">${p.name} </a></h3>
                                    ...
                                    <div style="display: flex; justify-content: center; align-items: center;">
                                        <c:forEach begin="${1}" end="${requestScope.num}" var="i">
                                            <p class="dispage" style="background-color: #000;  width: 30px; height: 20px; display: block; margin-right: 5px; cursor: pointer; clear: both"><a class="${i==page?'active':''}" style="color: white; padding-left: 11px; justify-content: center;align-items: center;" href="productfemale?page=${i}">${i}</a></p>                                
                                            </c:forEach>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <!--Sản phẩm bán chạy nhất không phân biệt category-->
                        <div class="product-list clearfix" >			
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <aside class="styled_header  use_icon ">
                            ...
                            <div class="row content-product-list products-resize">
                                <c:forEach items="${requestScope.data1}" var="p1" varStatus="loop">
                                    <div class="col-md-3 col-sm-6 col-xs-6 pro-loop">
                                        <div class="product-block product-resize">
                                            <div class="product-img image-resize view view-third">
                                                <div class="product-sale" >
                                                ...
                                                <a href="chitietsanpham?id=${p1.id}" title="${p1.name}">
                                            ...
                                            <div class="product-detail clearfix">
                                                <!-- sử dụng pull-left -->
                                                <h3 class="pro-name"><a href="chitietsanpham?id=${p1.id}" title="${p1.name}">${p1.name} </a></h3>
                                                <div class="pro-prices">	
                                ...
                                <div style="display: flex; justify-content: center; align-items: center;">
                                    <c:forEach begin="${1}" end="${requestScope.num1}" var="i1">
                                        <p class="dispage" style="background-color: #000;  width: 30px; height: 20px; display: block; margin-right: 5px; cursor: pointer; clear: both"><a class="${i1==page?'active':''}" style="color: white; padding-left: 11px; justify-content: center;align-items: center;" href="productfemale?page1=${i1}">${i1}</a></p>                                
                                        </c:forEach>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="product-list clearfix ">
                        <div class="row">
                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                <aside class="styled_header  use_icon ">
                                    <h3>Sản phẩm mới</h3>
                                    <span class="icon"><img src="/prj302/assets/theme.hstatic.net/icon_sale.png?v=90" alt="Newest trends"></span>
                                </aside>
                            </div>
                        </div>
                        <c:set var="page2" value="${requestScope.page2}"/>
                        <div class="row content-product-list products-resize">
                            <c:forEach items="${requestScope.data2}" var="p2" varStatus="loop">
                                <div class="col-md-3 col-sm-6 col-xs-6 pro-loop">
                                    <div class="product-block product-resize">
                                        <div class="product-img image-resize view view-third">
                                            <div class="product-sale" >
                                            ...
                                            <a href="chitietsanpham?id=${p2.id}" title="${p2.name}">
                                        ...
                                        <div class="product-detail clearfix">
                                            <!-- sử dụng pull-left -->
                                            <h3 class="pro-name"><a href="chitietsanpham?id=${p2.id}" title="${p2.name}">${p2.name} </a></h3>
                                            <div class="pro-prices">	
                            ...
                            <div style="display: flex; justify-content: center; align-items: center;">
                                <c:forEach begin="${1}" end="${requestScope.num2}" var="i2">
                                    <p class="dispage" style="background-color: #000;  width: 30px; height: 20px; display: block; margin-right: 5px; cursor: pointer; clear: both"><a class="${i2==page?'active':''}" style="color: white; padding-left: 11px; justify-content: center;align-items: center;" href="productfemale?page2=${i2}">${i2}</a></p>                                
                                    </c:forEach>
                            </div>
                        </div>
                    </div>
