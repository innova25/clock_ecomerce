                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="main-content">
                            ...
                            <c:set var="t" value="${requestScope.t}"/>
                            <div class="product-list clearfix">			
                                ...
                                <div class="row content-product-list products-resize">
                                    <c:forEach items="${requestScope.data3}" var="p3" varStatus="loop">
                                        <div class="col-md-3 col-sm-6 col-xs-6 pro-loop">
                                            <div class="product-block product-resize">
                                                <div class="product-img image-resize view view-third">
                                                    ...
                                                    <a href="chitietsanpham?id=${p3.id}" title="${p3.name}">
                                                ...
                                                <div class="product-detail clearfix">
                                                    <!-- sử dụng pull-left -->
                                                    <h3 class="pro-name"><a href="chitietsanpham?id=${p3.id}" title="${p3.name}">${p3.name} </a></h3>
