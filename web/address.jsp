...
<html class="no-js" lang="vi" >
    ...
    <head>
        ...
        <title>
            Địa chỉ &ndash; OxyWatch
        </title>

        <link rel="canonical" href="http://happylive.vn/account/addresses" />
...
//]]>
        ...
        (function () {
            function asyncLoad() {
                ...
                for (var i = 0; i < urls.length; i++) {
                    ...
                    s.type = 'text/javascript';s.async = true;s.src = urls[i];var x = document.getElementsByTagName('script')[0];x.parentNode.insertBefore(s, x);}}window.attachEvent ? window.attachEvent('onload', asyncLoad) : window.addEventListener('load', asyncLoad, false);
        })();
    //]]>
    </script>
    ...
    <script src='/prj302/assets/hstatic.net/haravan_common.js' type='text/javascript'></script>
    <script src='/prj302/assets/hstatic.net/customer_area.js' type='text/javascript'></script>
    ...
    <meta property="og:title" content="Địa chỉ" />
    <meta property="og:image" content="/prj302/assets/theme.hstatic.net/share_fb_home.png?v=90" />
    <meta property="og:image" content="/prj302/assets/theme.hstatic.net/share_fb_home.png?v=90" />
                                        ...
                                        <div class="AccountContent">
                                            <div class="AccountList">
                                                <ul class="list-unstyled">			
                                                    <li class="current"><a href="/prj302/thongtintaikhoan.jsp">Thông tin tài khoản</a></li>
                                                    <li class="last"><a href="logoutclient">Đăng xuất</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <div id="edit_address_1005298365" class="customer_address edit_address" style="display:none;">
                                                            <form accept-charset='UTF-8' action='/account/addresses/1005298365' id='address_form_1005298365' method='post'>
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <td class="value"><input type="text" id="address_last_name_1005298365" class="form-control textbox" name="address[last_name]"  size="40" value="" placeholder="Họ">
                                                                </div>
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                                                    <input type="text" id="address_first_name_1005298365" class="form-control textbox" name="address[first_name]"  size="40" value="" placeholder="Tên">
                                                                </div>        
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span> 
                                                                    <input type="text" for="address_company_1005298365" class="form-control textbox" name="address[company]" size="40"  value="" placeholder="Công ty">
                                                                </div>
                                                                <div class="input-group"> 
                                                                    <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                                                    <input type="text" id="address_address1_1005298365" class="form-control textbox" name="address[address1]" size="40"  value="" placeholder="Địa chỉ 1">
                                                                </div>
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                                                    <input type="text" id="address_address2_1005298365" class="form-control textbox" name="address[address2]"  size="40" value="" placeholder="Địa chỉ 2">
                                                                </div>
                                                                <div class="input-group">
                                                                ...
                                                                <div class="input-group" style="display:none">
                                                                    ...
                                                                    <input type="text" id="address_zip_1005298365" class="form-control textbox" name="address[zip]"  size="40" value="70000" >
                                                                </div>
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i class="glyphicon glyphicon-phone-alt"></i></span>
                                                                    <input type="text" id="address_phone_1005298365" class="form-control textbox" name="address[phone]"  size="40" value="" placeholder="Số điện thoại">
                                                                </div>
                                                                <div class="input-group">   
                                                                    <input type="checkbox" id="address_default_address_1005298365" name="address[default]" value="1">  Đặt làm địa chỉ mặc định.
                                                                </div> 
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5 pt20 row">
                                                ...
                                                <div id="add_address" class="customer_address edit_address" style="display:none;">
                                                    <form accept-charset='UTF-8' action='/account/addresses' id='address_form_new' method='post'>
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                                            <td class="value"><input type="text" id="address_last_name_new" class="form-control textbox" name="address[last_name]"  size="40" value="" placeholder="Họ" />
                                                        </div>
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
