                                                ...
                                                <tr>
                                                    <td class="img">
                                                        <a href="/products/dong-ho-nam-skmei-kim-xanh-duong">
                                                            <img src="/prj302/assets/product.hstatic.net/product/product/1_e0ed7c0240734782a8268793dce0b9b8_small.jpg " alt="ĐỒNG HỒ NAM SKMEI KIM XANH DƯƠNG" />
                                                        </a>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td class="img">
                                                        <a href="/products/dong-ho-nam-tevise-1952-chay-co-cuc-chat">
                                                            <img src="/prj302/assets/product.hstatic.net/product/product/7_0590d26379fb4da3ba8d9b57564ee6b0_small.jpg " alt="ĐỒNG HỒ NAM TEVISE 1952 CHẠY CƠ CỰC CHẤT" />
                                                        </a>
                                                    </td>
                                                    <td>
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-6 pro-loop">
                                            <div class="product-block product-resize">
                                                <div class="product-img image-resize view view-third">
                                                    ...
                                                    <a href="/products/dong-ho-nam-skmei-kim-xanh-duong" title="${p.name}">
                                                    ...
                                                    <div class="actionss">
                                                        <div class="btn-cart-products">
                                                            <a href="/prj302/xemgiohang.jsp" >
                                                                <i class="fa fa-shopping-bag" aria-hidden="true"></i>
                                                            </a>
                                                        </div>
                                                        <div class="view-details">
                                                            <a href="chitietsanpham?id=${p.id}" class="view-detail" > 
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-6 pro-loop">
                                        <div class="product-block product-resize">
                                            <div class="product-img image-resize view view-third">
                                                ...
                                                <a href="/products/dong-ho-nam-skmei-kim-xanh-duong" title="${p1.name}">
                                                ...
                                                <div class="actionss">
                                                    ...
                                                    <div class="view-details">
                                                        <a href="/prj302/chitietsanpham.jsp" class="view-detail" > 
                                                            <span><i class="fa fa-clone"> </i></span>
                                                        </a>
                                                    </div>
                                                    <div class="btn-quickview-products">
                                            ...
                                            <div class="product-detail clearfix">
                                                <!-- sử dụng pull-left -->
                                                <h3 class="pro-name"><a href="/products/dong-ho-nam-skmei-kim-xanh-duong" title="ĐỒNG HỒ NAM SKMEI KIM XANH DƯƠNG">${p1.name} </a></h3>
                                                <div class="pro-prices">	
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-6 pro-loop">
                                    <div class="product-block product-resize">
                                        <div class="product-img image-resize view view-third">
                                            ...
                                            <a href="/products/dong-ho-nam-skmei-kim-xanh-duong" title="${p2.name}">
