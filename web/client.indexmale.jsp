                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <aside class="styled_header  use_icon ">
                                            <h2>All</h2>
                                            <h3>TẤT CẢ SẢN PHẨM DÀNH CHO NAM</h3>
                                ...
                                <div class="row content-product-list products-resize">
                                    ...
                                    <div style="display: flex; justify-content: center; align-items: center;">
                                        <c:forEach begin="${1}" end="${requestScope.num}" var="i">
                                            <p class="dispage" style="background-color: #000;  width: 30px; height: 20px; display: block; margin-right: 5px; cursor: pointer; clear: both"><a class="${i==page?'active':''}" style="color: white; padding-left: 11px; justify-content: center;align-items: center;" href="productmale?page=${i}">${i}</a></p>                                
                                            </c:forEach>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row content-product-list products-resize">
                                ...
                                <div style="display: flex; justify-content: center; align-items: center;">
                                    <c:forEach begin="${1}" end="${requestScope.num1}" var="i1">
                                        <p class="dispage" style="background-color: #000;  width: 30px; height: 20px; display: block; margin-right: 5px; cursor: pointer; clear: both"><a class="${i1==page?'active':''}" style="color: white; padding-left: 11px; justify-content: center;align-items: center;" href="productmale?page1=${i1}">${i1}</a></p>                                
                                        </c:forEach>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row content-product-list products-resize">
                                ...
                                <div style="display: flex; justify-content: center; align-items: center;">
                                    <c:forEach begin="${1}" end="${requestScope.num2}" var="i2">
                                        <p class="dispage" style="background-color: #000;  width: 30px; height: 20px; display: block; margin-right: 5px; cursor: pointer; clear: both"><a class="${i2==page?'active':''}" style="color: white; padding-left: 11px; justify-content: center;align-items: center;" href="productmale?page2=${i2}">${i2}</a></p>                                
                                        </c:forEach>
                                </div>
                            </div>
                        </div>
